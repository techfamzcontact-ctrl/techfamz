  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full bg-accent-blue blur-[180px] opacity-[0.04]" />
        <div className="absolute bottom-[-15%] right-[-10%] w-[400px] h-[400px] rounded-full bg-[#E8A427] blur-[160px] opacity-[0.03]" />
      </div>
      ...
      <div className="relative py-20 px-5 md:py-[120px] md:px-6 max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="group bg-bg-card border border-border-glass rounded-xl p-8 backdrop-blur-md transition-all duration-400 ease-premium hover:-translate-y-2 hover:shadow-[0_12px_40px_rgba(0,0,0,0.4)] hover:border-border-glass-hover stagger-item relative overflow-hidden"
        ...
        {/* Bottom quote */}
        <div className="reveal reveal-delay-4 mt-16 flex justify-center">
