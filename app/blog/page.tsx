...
export default async function BlogIndexPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-[linear-gradient(180deg,#040810_0%,#0C1A3A_50%,#060B18_100%)] pt-32 pb-20">
        <div className="max-w-[1200px] mx-auto px-5 md:px-8">
          ...
          {posts === null ? (
            ...
            <div className="text-center py-20 border border-border-glass rounded-2xl bg-[rgba(10,16,34,0.4)] backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts.map((post) => (
                <Link 
                  href={`/blog/${post.slug}`} 
                  key={post.id}
                  className="group flex flex-col bg-[rgba(10,16,34,0.4)] border border-border-glass rounded-2xl overflow-hidden backdrop-blur-md transition-all duration-400 ease-premium hover:-translate-y-2 hover:shadow-[0_12px_40px_rgba(0,0,0,0.5)] hover:border-border-glass-hover"
                >
                  <div className="relative aspect-[16/10] overflow-hidden bg-[rgba(0,0,0,0.3)]">
                    ...
                    <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent_0%,rgba(6,11,24,0.8)_100%)] opacity-60" />
                  </div>
