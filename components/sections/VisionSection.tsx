...
export default function VisionSection() {
  return (
    ...
    >
      {/* Background Glow */}
      <div
        className="bg-glow bg-accent-blue opacity-12 blur-3xl animate-pulse-glow absolute rounded-full w-[400px] h-[400px] bottom-[10%] right-[5%] z-0"
      />
      ...
      <div className="relative py-20 px-5 md:py-[120px] md:px-6 max-w-[1200px] mx-auto text-center">
        ...
        <div className="animate-fade-in-up-delay-2 max-w-[680px] mx-auto">
          ...
          <div className="bg-bg-card border border-[rgba(59,130,246,0.15)] rounded-lg p-8  transition-all duration-400 ease-premium hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(0,0,0,0.3)] hover:border-border-glass-hover px-10 py-8 text-center">
