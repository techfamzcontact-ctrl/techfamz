...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <div className="bg-[rgba(10,16,34,0.4)] border border-border-glass rounded-xl overflow-hidden backdrop-blur-md">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="p-2 rounded-md text-text-muted hover:text-text-primary hover:bg-[rgba(255,255,255,0.05)] transition-colors"
